...
class RiddleLevelAdmin(admin.ModelAdmin):
    list_display = ('level_id', 'name', 'short_name', 'desc', 'kills', 'positive_score_percent', 'negetive_score_percent')
...
class RiddleAdmin(admin.ModelAdmin):
    list_display = ('riddle_id', 'category', 'riddle_level', 'type_riddle', 'max_calls', 'media', 'uin_code', 'question', 'answer_1', 'answer_2', 'answer_3', 'answer_4', 'answer_5', 'answer_6', 'answer_7', 'answer_8', 'answer_9', 'point', 'hint', 'answer_format')
...
class Hunter_Den_MappingAdmin(admin.ModelAdmin):
    list_display = ('map_id', 'den', 'hunter', 'member_since', 'member_status', 'invitation_code')
    list_filter = ('den', 'hunter')
    ordering = ('den', 'member_since',)
